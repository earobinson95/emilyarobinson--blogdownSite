...
GLS_unkownpsi <- function(y = y, x = x, func = expression(), theta0 = c(), psi0 = 0.5, tol = 10^{-8}, maxiter = 20){
  require(Deriv)
  require(MASS)
  ...
  return(list(C = iteration, theta = theta_new, psi = psi_new, sigma_sq = sigma_sq, V = V, W = W, yhat = yhat))
